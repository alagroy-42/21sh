...
#    Updated: 2019/07/22 20:19:10 by pcharrie         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_NAME = altkey.c ast_generate.c ast_set.c ast_tools.c builtin.c ctrl_key.c debugging.c \
			...
			autocmplt_tools.c expansions.c
